...
struct AppStoreReviewPathTests {
    ...
    func websiteHomePageLeadsWithProviderSpecificBuyerIntent() throws {
        ...
        #expect(homePage.contains("website_trial_download_clicked"))
        #expect(homePage.contains("website_trial_download_hero_clicked"))
        #expect(homePage.contains("data-cta=\"download_trial_hero_primary\""))
        #expect(homePage.contains("data-cta=\"download_oss\""))
        #expect(homePage.contains("credentials: 'omit'"))
        #expect(homePage.contains("referrerPolicy: 'no-referrer'"))
        #expect(!homePage.contains("sendBeacon"))
        ...
        #expect(!homePage.contains("data-cta=\"buy_bundle\""))
        #expect(homePage.contains("Download SaneSales"))
        #expect(homePage.contains("Every feature stays unlocked. Donate only if you want to support it."))
        #expect(homePage.contains("Free and open source."))
        #expect(homePage.contains("\"price\": \"0\""))
        #expect(homePage.contains("\"softwareVersion\": \"1.3.12\""))
